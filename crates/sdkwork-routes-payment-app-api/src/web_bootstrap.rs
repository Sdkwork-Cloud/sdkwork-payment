//! C17 修复：payment app-api 的 web framework 装配。
//!
...
use crate::http_route_manifest::{app_route_manifest, payment_app_api_public_path_prefixes};
...
pub fn wrap_router_with_web_framework(
    ...
    route_manifest
        .validate_public_path_prefixes(&payment_app_api_public_path_prefixes())
        .expect("payment app-api public prefixes must not cover protected manifest routes");
    ...
    let layer = sdkwork_iam_web_adapter::build_web_framework_layer(
        resolver,
        route_manifest,
        payment_app_api_public_path_prefixes(),
    )
...
mod tests {
    ...
    #[test]
    fn payment_app_framework_injects_authenticated_iam_context() {
