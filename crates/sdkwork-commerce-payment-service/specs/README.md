...
This directory is the local standards index for `sdkwork_commerce_payment_service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-payment-service` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-payment-service` |
| Domain | `commerce` |
| Capability | `payment` |
| Languages | `rust` |
| Status | `stable` |
