...
This directory is the local standards index for `@sdkwork/payment-pc-payment`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/payment-pc-payment` |
| Type | `react-package` |
| Root | `sdkwork-payment/apps/sdkwork-payment-pc/packages/sdkwork-payment-pc-payment` |
| Domain | `commerce` |
| Capability | `payment` |
