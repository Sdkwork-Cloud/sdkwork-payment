...
--
-- Payment capability baseline DDL for SQLite.
-- Mirrors the PostgreSQL baseline with SQLite-compatible types:
--   * Money stored as TEXT (canonical decimal string, e.g. "12.34"); application
--     layer uses i64 minor-cents arithmetic to avoid REAL floating point.
--   * Timestamps stored as ISO-8601 UTC TEXT (e.g. "2026-07-05T08:30:00Z").
--   * JSON stored as TEXT NOT NULL DEFAULT '{}'.
--   * Partial indexes (WHERE deleted_at IS NULL) supported since SQLite 3.8.0.
...
ALTER TABLE commerce_payment_method ADD COLUMN IF NOT EXISTS metadata TEXT NOT NULL DEFAULT '{}';
ALTER TABLE commerce_payment_method ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_method ADD COLUMN IF NOT EXISTS deleted_at TEXT;
...
ALTER TABLE commerce_payment_intent ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_intent ADD COLUMN IF NOT EXISTS deleted_at TEXT;
...
-- Self-heal: back-fill columns when the table was pre-created by another module.
ALTER TABLE commerce_payment_attempt ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_attempt ADD COLUMN IF NOT EXISTS deleted_at TEXT;
ALTER TABLE commerce_payment_attempt ADD COLUMN IF NOT EXISTS expires_at TEXT;
...
ALTER TABLE commerce_refund ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_refund ADD COLUMN IF NOT EXISTS deleted_at TEXT;
...
ALTER TABLE commerce_payment_channel ADD COLUMN IF NOT EXISTS metadata TEXT NOT NULL DEFAULT '{}';
ALTER TABLE commerce_payment_channel ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_channel ADD COLUMN IF NOT EXISTS deleted_at TEXT;
...
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS capabilities TEXT NOT NULL DEFAULT '{}';
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS metadata TEXT NOT NULL DEFAULT '{}';
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS certificate_expires_at TEXT;
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS last_tested_at TEXT;
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS last_test_status TEXT;
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS deleted_at TEXT;
...
-- Self-heal: back-fill columns when the table was pre-created by another module.
ALTER TABLE commerce_payment_route_rule ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_route_rule ADD COLUMN IF NOT EXISTS deleted_at TEXT;
...
ALTER TABLE commerce_payment_reconciliation_run ADD COLUMN IF NOT EXISTS total_difference_amount TEXT NOT NULL DEFAULT '0';
ALTER TABLE commerce_payment_reconciliation_run ADD COLUMN IF NOT EXISTS currency_code TEXT NOT NULL DEFAULT 'CNY';
ALTER TABLE commerce_payment_reconciliation_run ADD COLUMN IF NOT EXISTS version INTEGER NOT NULL DEFAULT 0;
ALTER TABLE commerce_payment_reconciliation_run ADD COLUMN IF NOT EXISTS deleted_at TEXT;
